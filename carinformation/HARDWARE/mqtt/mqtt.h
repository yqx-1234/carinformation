...
#define  S_NUM               5     //传感器数据缓存区个数
#define  SBUFF_UNIT          300   //传感器数据缓存区长度
...
extern unsigned char MQTT_RxSensorDataBuf[S_NUM][SBUFF_UNIT];     //传感器数据缓存区
extern unsigned char *MQTT_RxSensorDataInPtr;                  //指向传感器数据缓存区存放数据的位置
extern unsigned char *MQTT_RxSensorDataOutPtr;                 //指向传感器数据缓存区读取数据的位置
extern unsigned char *MQTT_RxSensorDataEndPtr;                 //指向传感器数据缓存区结束的位置
